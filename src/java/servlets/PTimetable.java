 ...
 * @author Stark
 */
public class PTimetable extends HttpServlet {
   ...
   @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql;
        String uploadPath = request.getRealPath("//files//Timetables//");
        ...
        while (files.hasMoreElements()) 
          { 
                 ...
                 if(currentFile == null) {
                     ...
                     sql = "insert into assignment values('"+myparams.get(2)+"','"+myparams.get(1)+"','"+myparams.get(0)+"','"+filename+"')";
