 ...
 * @author Stark
 */
public class PMstAttendance extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql;
        String uploadPath = request.getRealPath("//files//MST Attendance//");
        ...
        while (files.hasMoreElements()) 
          { 
                 ...
                 if(currentFile == null) {
                     ...
                     sql = "insert into midsem_attendance values('"+myparams.get(0)+"','"+myparams.get(1)+"','"+myparams.get(2)+"','"+filename+"')";
                     stat.executeUpdate(sql);
                     session.setAttribute("msg", "1");
                     response.sendRedirect("mstAttendance.jsp");
          }  
        } catch (Exception ex) {
