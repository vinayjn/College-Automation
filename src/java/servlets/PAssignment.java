 ...
 * @author Stark
 */
public class PAssignment extends HttpServlet {
   ...
   @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String sql;
        String uploadPath = request.getRealPath("//files//Assignments//");
        ...
        while (files.hasMoreElements()) 
          { 
                 ...
                 if(currentFile == null) {
                     ...
                     sql = "insert into assignment values('"+myparams.get(2)+"','"+myparams.get(0)+"','"+myparams.get(1)+"','"+filename+"')";
