<%-- 
    Document   : _feedResult
    Created on : Apr 5, 2014, 10:17:42 PM
    Author     : Stark
--%>
                    ...
                    <div class="well col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label for="cgpa" class="col-md-3 control-label">CGPA here</label>
                            </div>
                        </div> 
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="sgpa" class="col-md-3 control-label">SGPA</label>
                                <label for="sgpa" class="col-md-3 control-label">SGPA here</label>
                            </div>
                        </div>
                        <div class="col-md-12">
