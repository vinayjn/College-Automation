<%-- 
    Document   : mstAttendance
    Created on : Mar 23, 2014, 12:28:15 AM
    Author     : Stark
--%>
            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="POST">
                <div class="well col-sm-12 white" >
                        ...
                        <div class="col-sm-6">
                            <select id="semester" name="semester" class="form-control" required="required">
                                ...
                                <%
                                    for (int i = 1; i <= 8; i++) {
                                %>
                                <option value="<% out.print("Sem : " + i);%>"><% out.print("Sem : " + i);%></option>
                                <%
                                    }
                                %>
                            </select>
                    ...
                    <div class= "pull-right">
                        <button type="submit" formaction="pmstattendance" class="btn btn-success">Add </button>
